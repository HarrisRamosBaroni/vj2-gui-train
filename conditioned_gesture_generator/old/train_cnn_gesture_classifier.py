...
from .cnn_gesture_classifier import (
    CNNGestureClassifier, CNNGestureClassifierTrainer, CoordinateQuantizer, 
    compute_classification_loss, decode_predictions, create_model_and_trainer
)
...
def load_model_from_checkpoint(checkpoint_path, device='cuda'):
    ...
    from .cnn_gesture_classifier import CNNGestureClassifier, CoordinateQuantizer, CNNGestureClassifierTrainer
